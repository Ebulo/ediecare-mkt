  ...
  return (
    <>
      ...
      <section className="bg-gray-50 py-16 px-4 sm:px-6 lg:px-8">
        ...
        <form className="mt-12 max-w-xl mx-auto space-y-6">
          <div>
          ...
          <div>
            <button
              type="submit"
              className="w-full inline-flex justify-center py-3 px-6 border border-transparent shadow-sm text-base font-medium rounded-md text-white bg-gray-900 hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
            >
              Join the Waitlist
            </button>
          </div>
