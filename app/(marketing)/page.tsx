...
export default async function IndexPage() {
  ...
  return (
    <>
      <section className="space-y-6 pb-8 pt-6 md:pb-12 md:pt-10 lg:py-32" style={{ display: "flex", alignItems: "center", height: "60vh" }}>
      ...
      >
        <div className="mx-auto flex max-w-[58rem] flex-col items-center space-y-4 text-center">
          ...
          <p className="max-w-[85%] leading-normal text-muted-foreground sm:text-lg sm:leading-7">
            ...
            like what not, keep a track of the updates with us, join the waitlist now fill up the form and submit.
          </p>
        </div>
        <div className="mx-auto grid justify-center gap-4 sm:grid-cols-2 md:max-w-5xl md:grid-cols-3">
          <div className="relative overflow-hidden rounded-lg border bg-background p-2">
            <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
              ...
              <div className="space-y-2">
                <h3 className="font-bold">Healthcare Facilities</h3>
                <p className="text-sm text-muted-foreground">
                  Top notch healthcare facilities from Eddiecare
                </p>
              </div>
            </div>
          </div>
          <div className="relative overflow-hidden rounded-lg border bg-background p-2">
            <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
              ...
              <div className="space-y-2">
                <h3 className="font-bold">Life Support</h3>
                <p className="text-sm">
                  One stop solution, to all you need.
                </p>
              </div>
            </div>
          </div>
